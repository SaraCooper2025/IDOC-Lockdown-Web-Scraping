        ...
        for site in sites:
            try:
                ...
                if now_cst.hour >= 23 or now_cst.hour < 7:
                    ...
                    shift = 'Shift 3'
                results.append({"URL": facility_name, "Contains Key Phrase": found, "Date": current_date, "Shift": shift})
            except Exception as e:
                results.append({"URL": facility_name, "Contains Key Phrase": False, "Error": str(e)})
        await browser.close()
